...
import net.ion.bleujin.script.AbstractListener;
import net.ion.bleujin.script.DirClassLoader;
import net.ion.bleujin.script.FileAlterationMonitor;
import net.ion.bleujin.script.IdString;
import net.ion.bleujin.script.OuterClassLoader;
import net.ion.bleujin.script.ResultHandler;
import net.ion.bleujin.script.Scripter;
import net.ion.bleujin.script.StringInputStream;
...
public class JScriptEngine extends Scripter {
	...
	private JScriptEngine(ClassLoader cloader) {
		...
		this.sengine = manager.getEngineByName("Nashorn"); // GraalJS, Nashorn
